...
Route::group(['prefix' => 'data'], function(){
    ...
    Route::get('lihat.data-pengeluaran/{expenditure}', 'ExpenditureController@show')->name('lihat.data-keluar');

    Route::delete('hapus.data-pengeluaran/{expenditure}', 'ExpenditureController@destroy')->name('hapus.data-keluar');
});
